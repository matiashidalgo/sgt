 ...
 * @since 1.1
 */
class CBotonesClientes extends CGridColumn
{
	/**
	 ...
	 */
	public $template='{view} {update} {delete} {verordenes}';
	/**
	...
	public $verordenesButtonLabel;
	
	public $verordenesButtonImageUrl;
	
	public $verordenesButtonUrl='Yii::app()->controller->createUrl("ordenes/listarbycliente",array("id"=>$data->primaryKey))';
	
	public $verordenesButtonOptions=array('class'=>'view');
	...
	protected function initDefaultButtons()
	{
		...
		if($this->verordenesButtonLabel===null)
			$this->verordenesButtonLabel=Yii::t('zii','vieworders');
		...
		if($this->verordenesButtonImageUrl===null)
			$this->verordenesButtonImageUrl=$this->grid->baseScriptUrl.'/view2.png';
		if($this->deleteConfirmation===null)
			$this->deleteConfirmation=Yii::t('zii','Are you sure you want to delete this item?');

		foreach(array("view","update","delete","verordenes") as $id)
		{
			$button=array(
